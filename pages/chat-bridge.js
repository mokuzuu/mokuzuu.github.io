...
const Index = () => {
    return (
        <p>
           Privacy Policy for ChatBridge

1. Introduction

Welcome to ChatBridge. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application. Please read this policy carefully. If you do not agree with the terms of this privacy policy, please do not access the application.
...
Our application allows users to create audio recordings. These recordings are sent to a third-party service, Whisper by OpenAI, for transcription. The transcriptions are stored within our application.
...
If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at matsumoto_taiga@outlook.jp.
